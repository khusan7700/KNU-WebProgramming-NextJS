...
const PropertyList: NextPage = () => {
  ...
  const eventsData: EventData[] = [
    ...
    },
    {
      ...
      description:
        "일반대학원과 인문대학의 여러 학과가 함께 사용하는 건물이다.",
    ...
    },
    {
      ...
      description:
        "식당, 편의점, 우편취급국, 서점, 쇼핑플라자들이 입점한 건물.",
  ...
  if (device === "mobile") {
    return <Stack>PROPERT MOBILE</Stack>;
  } else {
    return (
            ...
            <Stack className={"main-config"} mb={"76px"}>
              <Stack className={"list-config"}>
                {eventsData.map((event: EventData) => {
                  return <PropertyCard event={event} key={event?.department} />;
                })}
              </Stack>
              <Stack pagination-config>
                ...
                <Stack className="total-result">
                  <Typography>Total 5 properties acailable</Typography>
                </Stack>
              </Stack>
            </Stack>
          </Stack>
